...
fn parse_run(mut args: Vec<String>) -> Result<Cli, String> {
...
fn parse_set(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
...
fn parse_get(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
...
fn parse_reset(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
    if !args.is_empty() {
        return Err(format!(
...
fn parse_outputs(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
...
fn parse_exclude(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
...
fn parse_stop(mut args: Vec<String>) -> Result<Cli, String> {
    let socket = extract_socket_arg(&mut args)?;
    if !args.is_empty() {
